...
import { AutoNote, FakeUser } from "./fakeUser";
    ...
    */
    ...
    public getNotesFromBoard = (): NoteWithVotes[] => {
        ...
        this.notesMap.forEach((i: INote) => {
            ...
            let voted = false;
            if (votes.has(i.id)) {
                const votesObj = votes.get(i.id) as any;
                numVotes = votesObj.count as number;
                voted = votesObj.voted as boolean;
            }
